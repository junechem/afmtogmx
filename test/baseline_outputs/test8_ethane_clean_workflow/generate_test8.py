...
# Generate nonbonded potentials (uses config values)
print("\nStep 3: Generate nonbonded tabulated potentials")
print("-" * 70)
nonbonded_tabpot = off.gen_nonbonded_tabpot()
print("[OK] Nonbonded potentials generated")

# Write nonbonded potentials (uses config prefix and directory)
...
# Generate bonded potentials (uses config values)
print("\nStep 5: Generate bonded tabulated potentials")
print("-" * 70)
bonded_tabpot = off.gen_bonded_tabpot()
print("[OK] Bonded potentials generated")

# Write bonded potentials (uses config prefix and directory)
...
print("  2. Call workflow methods without repetitive parameters")
print("  3. Use method chaining for cleaner code")
print("\nCompare this to traditional approach (see test2) where you would")
print("pass spacing, length, prefix, etc. to every method call.")
print("\nGenerated files:")
print("  - topol.top")
